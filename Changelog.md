 ...
 * Yul EVM Code Transform: Stack Optimization: Defer allocating stack slots for return variables until after any expression statements and assignments that do not reference them.
